...
use Systha\CompanyPanel\Http\Controllers\Api\Company\CompanyGeneralSettingsController;
...
use Systha\CompanyPanel\Http\Controllers\Api\Company\CompanyPageController;
...
Route::prefix('api')->group(function (): void {
    ...
    Route::middleware(CompanyJwtAuth::class)->group(function (): void {
        ...
        Route::middleware(CompanyContextFromToken::class)->prefix('company/{company}')->group(function (): void {
            ...
            Route::get('general-settings', [CompanyGeneralSettingsController::class, 'show']);
            Route::put('general-settings', [CompanyGeneralSettingsController::class, 'update']);
            Route::put('general-settings/logo', [CompanyGeneralSettingsController::class, 'updateLogo']);
            Route::get('pages', [CompanyPageController::class, 'index']);
            Route::post('pages', [CompanyPageController::class, 'store']);
            Route::put('pages/{id}', [CompanyPageController::class, 'update']);
